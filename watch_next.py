...
def recommend_movie(description: str, mov_dict: dict) -> str:
...
print(recommend_movie(initial_description, movies_dict),
      movies_dict[recommend_movie(initial_description, movies_dict)])
